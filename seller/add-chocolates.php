...
<div class="main-contant">
    <div class="wrapper">
        ...
        <form action="../product_controler/addChocolateCheck.php" method="post" enctype="multipart/form-data">
            <table class="tbl-full">
                <tr>
                    <td>Product Name: </td>
                    <td> <input type="text" name="name" placeholder="Product Name" id=""></td>
                </tr>

                <tr>
                    <td>Buying Price: </td>
                    <td> <input type="text" name="buyingPrice" placeholder="Buying Price" id=""></td>
                </tr>

                
                <tr>
                    <td>Selling Price: </td>
                    <td> <input type="text" name="sellingPrice" placeholder="Selling Price" id=""></td>
                </tr>

                <tr>
                    <td>Company Name: </td>
                    <td> <input type="text" name="company" placeholder="Company Name" id=""></td>
                </tr>
