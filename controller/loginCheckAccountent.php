    ...
    if(isset($_POST['submit'])){
        ...
        $type = $_POST['type'];
          ...
          //sql to check the email and pass
		    $sql = "SELECT * FROM accountent WHERE email= '$email' AND password='$password' "; 
		    ...
		    if($count==1)
		    {
                ...
                $_SESSION['user'] = $email;
				$_SESSION['user'] = $password; //to check login or not
		    ...
		    else
		    {
		    	...
		    	header('location: ../view/loginAccountent.php');
		    }
