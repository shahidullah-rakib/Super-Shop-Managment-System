    ...
    <div class="main-content">
        <div class="wrapper">
            ...
            <?php
                ...
                <td>{$var['address']}</td>
                <td>
                    <a href='admin-update-password.php?id={$var['id']}' class='btn-primary'>Change Password</a> </br>
                    <a href='admin-update.php?id={$var['id']}' class='btn-secondary'>Update</a>
                    <a href='../controller/admin-delete-check.php?id={$var['id']}' name='delete' class='btn-denger'>Delete</a>
