...
<div class="main-contant">
    <div class="wrapper">
        <h1>Update Accountent</h1>

        <?php
            $id = $_GET['id'];

            $status= displayAccountentbyID($id, $conn);
        
        ?>
        

        <form action="../controller/updateAccountentCheck.php" enctype="multipart/form-data" method="post">
            <table class="tbl-30">
                <tr>
                    <td>Full Name: </td>
                ...
                <tr>
                    <td colspan="2"> 
                        ...
                        <input type="submit" name="submit" value=" Update Accountent" class="btn-secondary">
                    </td>
                </tr>
