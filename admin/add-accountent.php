...
<div class="main-contant">
    <div class="wrapper">
        ...
        <form action="../controller/addAccountentCheck.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
...
<script src="../js/accountentValidation.js"></script>
