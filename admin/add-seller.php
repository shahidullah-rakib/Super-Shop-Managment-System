...
<div class="main-contant">
    <div class="wrapper">
        ...
        <form action="../controller/addSellerCheck.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
            <table class="tbl-full">
                <tr>
                    <td>Full Name: </td>
                    <td> <input type="text" name="name" placeholder="Full Name" id="aName">
                ...
                <tr>
                    <td>Password: </td>
                    <td> <input type="password" name="password" placeholder="Password" id="aPassword">
                ...
                <tr>
                    <td>Date Of Birth: </td>
                    <td> <input type="date" name="dob" id="aDob">
                ...
                <tr>
                    <td>Phone Number: </td>
                    <td> <input type="tel" name="phonenumber" placeholder="Phone Number" id="aPhonenumber">
                ...
                <tr>
                    <td>Email: </td>
                    <td> <input type="email" name="email" placeholder="Email Address" id="aEmail">
                ...
                <tr>
                    <td>Address: </td>
                    <td> <textarea name="address" rows="10" placeholder="Street, City, Country" id="aAddress"></textarea>
                ...
                <tr>
                    <td colspan="2"> 
                        <input type="submit" name="submit" value=" Add Seller" class="btn-secondary">
